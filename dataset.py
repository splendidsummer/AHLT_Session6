                ...
                for s in sentences:
                    ...
                    for p in pairs:
                        ...
                        for tk in range(1, tree.get_n_nodes()):
                            ...
                            if tk_ent is None: token = {'form': tree.get_word(tk), 'lc_form':tree.get_word(tk).lower(), 'lemma': tree.get_lemma(tk), 'pos': tree.get_tag(tk), 'etype': 'null'}
                        ...
                        # print({'sid': sid, 'e1': e1, 'e2': e2, 'type': dditype, 'sent': sent,
                        #        'e1type': entities[e1]['type'], 'e2type': entities[e2]['type']})
